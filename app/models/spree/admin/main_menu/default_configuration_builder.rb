        ...
        def add_settings_section(root)
          items = [
            ...
            ItemBuilder.new('roles', admin_roles_path).with_manage_ability_check(Spree::Role).
              ...
              build,
            ItemBuilder.new('permission_sets', admin_permission_sets_path).with_manage_ability_check(Spree::PermissionSet).
              with_match_path('/permission_sets').
              build,
            ItemBuilder.new('permissions', admin_permissions_path).with_manage_ability_check(Spree::Permission).
              with_match_path('/permissions').
              build
          ]
