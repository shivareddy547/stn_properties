...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<actionview>.freeze, [">= 4.1".freeze, "<= 7.2".freeze])
  s.add_development_dependency(%q<actionpack>.freeze, [">= 4.1".freeze, "<= 7.1".freeze])
  s.add_development_dependency(%q<appraisal>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<rspec-rails>.freeze, ["~> 4.0.1".freeze])
